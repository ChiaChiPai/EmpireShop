...
export default {
  ...
  methods: {
    // get page_id
    getFB_Content () {
      const api = 'https://script.google.com/macros/s/AKfycbxijUKhxUBuASlcCg7jRH3eSrrEXEIdmQhhWC-Zs3d0Tlh4VaUE/exec?url=https://graph.facebook.com/v6.0/ageEmpireShop/feed?access_token=EAAL5Tx0lRX0BAPWlyqaK1X82SwV29NyW1VPoSfKsI5TiXghZAVugInKEFhuNdWfYsG6DWKg5qrBTOqRnC5QUrIyRQnaGZAu2jZAv3iqFHpZA1gWdyEMxoMEPw9kUgA9frCZArxDKO7h0YZC8fvmA8ZAHaapgI4RXYe0wUhZCrK4NYAZDZD'
